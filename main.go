...
import (
	...
	"github.com/mudler/img-controller/pkg/generated/controllers/core"
	"github.com/mudler/img-controller/pkg/generated/controllers/img.k8s.io"
...
func main() {
	...
	sample := img.NewFactoryFromConfigOrDie(cfg)
	...
	Register(ctx,
		...
		sample.Img().V1alpha1().ImageBuild())
